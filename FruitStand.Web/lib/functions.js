...
(function ($) {
    ...
    SEMICOLON.header = {
        ...
        topcart: function () {
            ...
            // Harish: Unbind the click event before binding. otherwise, it bind the click event everytime when it calls. Don't take togeration about already event attached or not
            $("#top-cart-trigger").unbind("click").bind("click", (function (e) {
                $pagemenu.toggleClass('pagemenu-active', false);
    ...
    SEMICOLON.widget = {
        ...
        notifications2: function (notifyType, notifyMsg, notifyPosition, notifyCloseButton) {
            toastr.clear();
    ...
    SEMICOLON.documentOnResize = {
        ...
        init: function () {
            ...
            console.log("documentOnResize:init");
            var t = setTimeout(function () {
                SEMICOLON.init();
